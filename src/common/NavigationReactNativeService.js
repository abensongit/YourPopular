 ...
 * 全局导航跳转工具类
 */
export default class NavigationReactNativeService {
  /**
   * 跳转至指定页面
   * @param page
   * @param params
  ...
  static navigate(page, params = {}) {
    const { topLevelNavigator } = NavigationReactNativeService;
  ...
  static openDrawer(params = {}) {
    const { topDrawerNavigator } = NavigationReactNativeService;
