...
const STORAGE_FAVOURITE_TRENDING_KEY = 'STORAGE_FAVOURITE_TRENDING_KEY';

export default class TrendingFavouriteDao {
  /**
   * 构造函数
   * @param flag
   */
  constructor() {
    this.favouriteKey = STORAGE_FAVOURITE_TRENDING_KEY;
  }
